(function() {
  var Box, DICT_FLAG, DictFlag, HIDDEN_VAR_PREFIX, Tin, Var, Variable, bind, bind_tins, boxit, dir, extern, g_hidden_var_counter, get_tin, internal, isHiddenVar, isarray, isbool, isfunc, isnum, isobj, isstr, isundef, isvaluetype, len, log, mergeJson, parse, rollback, str, toJson, unboxit, unify, _unify;
