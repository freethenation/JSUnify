...
(function() {
  var Box, DICT_FLAG, DictFlag, FunctionCondition, HIDDEN_VAR_PREFIX, Program, Rule, Tin, Var, Variable, backtrack, bind, bind_tins, boxit, dir, extern, g_hidden_var_counter, get_tin, internal, isHiddenVar, isarray, isbool, isfunc, isnum, isobj, isstr, isundef, isvaluetype, len, log, parse, rollback, str, toJson, tryFunctionCondition, tryUnifyCondition, unboxit, unify, _unify,
    __slice = [].slice,
  ...
  extern = function(name, o) {
    if (typeof exports === 'undefined') {
      return window.JSUnifyLang[name] = o;
    } else {
      return exports[name] = o;
    }
  };
  ...
  internal = function(name, o) {
    if (typeof exports === 'undefined') {
      return window.JSUnifyLang.internal[name] = o;
    } else {
      return exports.internal[name] = o;
    }
  };
