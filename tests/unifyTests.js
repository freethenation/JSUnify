(function() {
  var Box, DICT_FLAG, DictFlag, HIDDEN_VAR_PREFIX, Tin, Var, Variable, bind, bind_tins, boxit, dir, extern, fulltest, g_hidden_var_counter, get_tin, gettest, internal, isHiddenVar, isarray, isbool, isfunc, isnum, isobj, isstr, isundef, isvaluetype, len, log, parse, parsetest, rollback, runtests, str, toJson, unboxit, unify, unifyfailtest, unifytest, _unify;
